...
const EXEMPLARS = [
  ...
  },
  {
    ...
    "StudentBenefits": "- This lesson was teacher-focused, but the same AI could be used by students to accommodate their own needs",
  ...
  },
  {
    ...
    "StudentBenefits": "- Fast way to re-engage with previous material",
  ...
  },
  {
    ...
    "StudentBenefits": "- Idea generation support, personalized guidance, improved pre‑writing, digital literacy skills",
  ...
  },
  {
    ...
    "StudentBenefits": "- They used a bot to learn about the three Laws of Robotics",
  ...
  },
  {
    ...
    "TeacherBenefits": "- Class is engaged, fewer behavior disruptions, easy prep once AI literacy skills have been taught, differentiation for diverse learning needs by giving text and visuals",
    "StudentBenefits": "- High engagement with choice and structure; the focus was not on memorizing facts but on the discussion after learning",
    "InstructionalStrategy": "Differentiation, Student Engagement, Idea Generation, Creative Arts",
    "GradeLevels": ["4th"],
    "SubjectArea": ["Science"],
    "StudentFacing": false,
